#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Simple python command line tool to pack / unpack the Amazfit GTR and Verge Lite font firmware files
...
dirname = "bmp-vergelite"


# Unpack the Amazfit GTR/Verge Lite font file
...
# Create a Amazfit GTR/Verge file from bmps
